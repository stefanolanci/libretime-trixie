...
class PypoPush(Thread):
    ...
    def __init__(
        ...
        config: Config,
        post_present_media_sync: Optional[Callable[[], None]] = None,
    ):
        ...
        self._post_present_media_sync = post_present_media_sync
        self._post_present_media_sync_done = False
        ...
        while True:
            ...
            if (
                ...
                try:
                    ...
                    logger.exception("post_present_media_sync hook failed")
