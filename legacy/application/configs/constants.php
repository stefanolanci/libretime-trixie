...
define('USER_MANUAL_URL', 'https://github.com/stefanolanci/libretime-trixie/blob/main/README.md');
...
define('LIBRETIME_CONTRIBUTE_URL', 'https://github.com/stefanolanci/libretime-trixie/issues');
