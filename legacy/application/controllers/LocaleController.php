...
final class LocaleController extends Zend_Controller_Action
{
    ...
    public function generalTranslationTableAction()
    {
        $translations = [
            ...
            // dashboard/dashboard.js — PLC panel
            'No data' => _('No data'),
            'No active track' => _('No active track'),
            'Idle' => _('Idle'),
            'File cached and ready' => _('File cached and ready'),
            'Downloading file...' => _('Downloading file...'),
            'Fetch error!' => _('Fetch error!'),
            'Waiting for schedule' => _('Waiting for schedule'),
            'Playing' => _('Playing'),
            'Queued, waiting to play...' => _('Queued, waiting to play...'),
            'Playback error!' => _('Playback error!'),
            'Sending to player...' => _('Sending to player...'),
            'Not yet sent' => _('Not yet sent'),
            'Audio on air' => _('Audio on air'),
            'Stream silent!' => _('Stream silent!'),
            'Waiting for audio confirmation...' => _('Waiting for audio confirmation...'),
            'Waiting for playback' => _('Waiting for playback'),
            'On air' => _('On air'),
            'Queued in LS' => _('Queued in LS'),
            'Ready' => _('Ready'),
            'File OK' => _('File OK'),
            'Scheduled' => _('Scheduled'),
            'Received' => _('Received'),
            'Waiting' => _('Waiting'),
            'Schedule not received' => _('Schedule not received'),
            'File not ready' => _('File not ready'),
            'Send stalled' => _('Send stalled'),
            'Player not responding' => _('Player not responding'),
            'Removed but still playing' => _('Removed but still playing'),
            'Stream silent' => _('Stream silent'),
            'Late start' => _('Late start'),
        ];
        $this->view->layout()->disableLayout();
        $this->_helper->viewRenderer->setNoRender(true);
        header('Content-Type: text/javascript');
