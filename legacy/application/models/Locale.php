...
final class Application_Model_Locale
{
    ...
    {
        $codeset = 'UTF-8';
        $localeCode = is_null($locale) ? Application_Model_Preference::GetLocale() : $locale;
        $lang = $localeCode . '.' . $codeset;
        ...
        if (setlocale(LC_ALL, $lang, $localeCode . '.utf8', $localeCode, 'C.UTF-8') === false) {
